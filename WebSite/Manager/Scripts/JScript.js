...
function RefMethod1(path, index, warning, target, ensName, keys) {
    ...
    var url = "/WF/Comm/RefMethod.aspx?Index=" + index + "&EnsName=" + ensName + keys;
...
function onDDLSelectedMore(ddlID, MainEns, EnsName, refkeyvalue, reftext) {
    var url = '';
    url = "/WF/Comm/DataHelp.htm?HelperOfDDL.aspx?EnsName=" + EnsName + "&RefKey=" + refkeyvalue + "&RefText=" + reftext + "&MainEns=" + MainEns + "&DDLID=" + ddlID;
